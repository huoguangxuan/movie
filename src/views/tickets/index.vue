  ...
  <div class="home">
    ...
    <div class="film">
      <div class="filmhead">
        ...
        <router-link
          :to="{
            path: num == 1 ? '/films/hotfilms' : '/films/thefilms',
            query: { active: num == 1 ? 0 : 1 }
          }"
        >
        ...
        <ul class="filmcont" ref="filmcont">
          ...
          <li class="cont-item" v-for="(item, index) in fail" :key="index">
            ...
            <router-link :to="{ name: 'cinemas' }">
              <van-button class="bytick" round type="info">购票</van-button>
            </router-link>
          </li>
        </ul>
      </div>
        ...
        <ul class="filmcont" ref="comingcont">
          ...
          <li class="cont-item" v-for="(item, index) in coming" :key="index">
            ...
            <div @click="wantlook(index)">
              <van-button class="wantlook" v-show="true" round type="info"
                >想看</van-button
              >
              <van-button class="thinklook" v-show="false" round type="info"
                >已想看</van-button
              >
            </div>
          </li>
